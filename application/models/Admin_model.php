...
class Admin_model extends CI_Model
{
    ...
    {
        $this->db->join('kategori k', 'b.kategori_id = k.id_kategori');
        $this->db->join('satuan s', 'b.satuan_id = s.id_satuan');
        $this->db->order_by('id_barang');
        return $this->db->get('barang b')->result_array();
    }

    public function getL($table,$data=null)
    {
        if ($data != null) {
    ...
    {
        $this->db->join('role_lokasi r', 'l.id_role_lokasi=r.id_rolelokasi');

        $this->db->order_by('l.id_lokasi');
        return $this->db->get('lokasi l')->result_array();
    }
    ...
    public function getBarangMasuk($limit = null, $id_barang = null, $range = null)
    {
        ...
        $this->db->join('lokasi l', 'bm.lokasi_id = l.id_lokasi');
    ...
    public function getBarangKeluar($limit = null, $id_barang = null, $range = null)
    {
        ...
        $this->db->join('lokasi l', 'bk.lokasi_id = l.id_lokasi');
