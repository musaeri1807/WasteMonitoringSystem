        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="id_barang">ID Kode</label>
                    <div class="col-md-9">
                        <input readonly value="<?= set_value('id_barang', $id_barang); ?>" name="id_barang" id="id_barang" type="text" class="form-control" placeholder="ID Kode...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('nama_barang'); ?>" name="nama_barang" id="nama_barang" type="text" class="form-control" placeholder="Nama Sampah...">
                        ...
                        <div class="input-group">
                            <select name="kategori_id" id="kategori_id" class="custom-select">
                                ...
                                <?php foreach ($kategori as $j) : ?>
                                    <option <?= set_select('id_kategori', $j['id_kategori']) ?> value="<?= $j['id_kategori'] ?>"><?= $j['nama_kategori'] ?></option>
                                <?php endforeach; ?>
                            </select>
