...
<head>
    ...
    <title><?= $title; ?> | Waste Monitoring System</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('Lokasi'); ?>">
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Waste Monitoring System 2022 &bull; by <?= anchor('#', 'musaeri.com'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
