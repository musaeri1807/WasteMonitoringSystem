    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="lokasi_id">Lokasi</label>
                    <div class="col-md-5">
                        <div class="input-group">
                            <select name="lokasi_id" id="lokasi_id" class="custom-select">
                                <option value="" selected disabled>Pilih Lokasi</option>
                                <?php foreach ($lokasi as $l) : ?>
                                    <option <?= set_select('lokasi_id', $l['id_lokasi']) ?> value="<?= $l['id_lokasi'] ?>"><?= $l['nama_lokasi'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="input-group-append">
                                <a class="btn btn-primary" href="<?= base_url('Lokasi/add'); ?>"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                ...
                <div class="row form-group" hidden>
                    <label class="col-md-4 text-md-right" for="kategori_id">Kategori</label>
                    <div class="col-md-5">
                        <input readonly="readonly" name="kategori_id" id="kategori" type="text" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
